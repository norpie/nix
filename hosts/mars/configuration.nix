{
  ...
  imports = [
    ...
    ./hardware.nix
    inputs.hardware.nixosModules.lenovo-thinkpad-t490s
    ...
    # (configLib.relativeToRoot "hosts/common/optional/jupiters/hyprland-env.nix")
    ...
    (configLib.relativeToRoot "hosts/mars/syncthing.nix")
    (configLib.relativeToRoot "hosts/mars/zerotierone.nix")
